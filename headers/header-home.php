            ...
            <div class="menu-left">
                <div class="adjust-display">
                    <ul class="nav nav-tabs" id="deviceTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="" id="todesktop" data-toggle="tab" role="tab" aria-selected="true">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="" id="totablet" data-toggle="tab" role="tab" aria-selected="false">
